...
const ACPI_PREDEFINED_INFO          AcpiGbl_PredefinedMethods[] = {
	...
	}, /* Variable-length (Pkgs) each: 1 Buf, 1 Pkg */
	...
	}, /* Internal use only, used by ACPICA test suites */
	...
	}, /* Variable-length (1 Int(rev), n Pkg (2 Int) */
	...
	}, /* Variable-length (Pkgs) each (1 Str/1 Buf) */
	...
	},   /* Acpi 1.0 allowed 1 integer arg. Acpi 3.0 expanded to 3 args. Allow both. */
