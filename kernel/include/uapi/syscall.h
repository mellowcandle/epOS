...
*/
#ifndef SYSCALL_H_M6WW51RJ
#define SYSCALL_H_M6WW51RJ
...
{ \
  int a; \
  asm volatile("int $0x40" : "=a" (a) : "0" (num)); \
  return a; \
}
...
{ \
  int a; \
  asm volatile("int $0x40" : "=a" (a) : "0" (num), "b" ((int)p1)); \
  return a; \
}
...
{ \
  int a; \
  asm volatile("int $0x40" : "=a" (a) : "0" (num), "b" ((int)p1), "c" ((int)p2)); \
  return a; \
}
...
{ \
  int a; \
  asm volatile("int $0x40" : "=a" (a) : "0" (num), "b" ((int)p1), "c" ((int)p2), "d"((int)p3)); \
  return a; \
}
...
{ \
  int a; \
  asm volatile("int $0x40" : "=a" (a) : "0" (num), "b" ((int)p1), "c" ((int)p2), "d" ((int)p3), "S" ((int)p4)); \
  return a; \
}
...
{ \
  int a; \
  asm volatile("int $0x40" : "=a" (a) : "0" (num), "b" ((int)p1), "c" ((int)p2), "d" ((int)p3), "S" ((int)p4), "D" ((int)p5)); \
  return a; \
}
